...
def write_bulk(path):
    with path.open("w",newline="") as f:
        w=csv.DictWriter(f,fieldnames=["Item Title","Sold Price","Shipping","Sold Date","Item ID","Currency"]); w.writeheader()
        w.writerow({"Item Title":title(),"Sold Price":"$100","Shipping":"$0.00","Sold Date":"2026-08-01","Item ID":"1","Currency":"USD"})
