...
def _write_csv(path):
    rows = [
        (1, "2026-08-01", 100), (2, "2026-08-02", 110), (3, "2026-08-03", 120),
        (4, "2026-08-11", 130), (5, "2026-08-12", 140), (6, "2026-08-13", 150),
    ]
...
def test_cli_turns_product_research_export_into_repricing_artifact(tmp_path):
    ...
    asset_path.write_text(json.dumps(_asset()), encoding="utf-8")
    _write_csv(csv_path)
