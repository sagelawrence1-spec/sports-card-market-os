...
def _row(price="$100", sold_date="2026-08-01", item_id="123"):
    return {"Item Title":"2018 Topps Chrome Update Shohei Ohtani HMT1 PSA 10","Sold Price":price,"Shipping":"$0.00","Sold Date":sold_date,"Item ID":item_id,"Currency":"USD"}
