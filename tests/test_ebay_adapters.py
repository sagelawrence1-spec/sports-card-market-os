...
with tempfile.TemporaryDirectory() as td:
    ...
    with p.open('w',newline='',encoding='utf-8') as f:
        ...
        w.writerow({'Item Title':'Bad date comp','Sold Price':'$100.00','Sold Date':'eventually','Item ID':'992','Currency':'USD','Shipping':'$0.00'})
        ...
        w.writerow({'Item Title':'Price range comp','Sold Price':'$100-$150','Sold Date':'2026-08-04','Item ID':'995','Currency':'USD','Shipping':'$0.00'})
        w.writerow({'Item Title':'Missing stable identity','Sold Price':'$175.00','Sold Date':'2026-08-05','Currency':'USD','Shipping':'$0.00'})
        w.writerow({'Item Title':'Conflicting identity','Sold Price':'$180.00','Sold Date':'2026-08-06','Item ID':'997','Item URL':'https://www.ebay.com/itm/998','Currency':'USD','Shipping':'$0.00'})
        w.writerow({'Item Title':'   ','Sold Price':'$190.00','Sold Date':'2026-08-07','Item ID':'999','Currency':'USD','Shipping':'$0.00'})
        w.writerow({'Item Title':'Unknown shipping comp','Sold Price':'$200.00','Sold Date':'2026-08-08','Item ID':'1000','Currency':'USD','Shipping':''})
        ...
        w.writerow({'Item Title':'Explicit USD conflicts with raw price','Sold Price':'C$220.00','Sold Date':'2026-08-10','Item ID':'1002','Currency':'USD','Shipping':'$0.00'})
        w.writerow({'Item Title':'USD sale with foreign shipping','Sold Price':'$230.00','Sold Date':'2026-08-11','Item ID':'1003','Currency':'USD','Shipping':'C$15.00'})
        w.writerow({'Item Title':'Malformed explicit item identity','Sold Price':'$240.00','Sold Date':'2026-08-12','Item ID':'row-1004','Item URL':'https://www.ebay.com/itm/1004','Currency':'USD','Shipping':'$0.00'})
    ...
    assert rr.metadata['accepted_rows']==2 and rr.metadata['rejected_rows']==12
    assert rr.metadata['rejection_reasons']=={
        'conflicting_currency_evidence':1,
        'conflicting_item_id':1,
        'conflicting_shipping_currency':1,
        'invalid_item_id':1,
