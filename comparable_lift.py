...
def evaluate_comparable_lift(
    ...
    *,
    ...
    The gate is deliberately conservative: comparable intelligence cannot graduate merely
    because aggregate metrics look good. Every represented family must have a mature
    sample floor, and the aggregate result must beat the simple sold-comp baseline on
    MAE while not degrading directional accuracy beyond policy.
    """
